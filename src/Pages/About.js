  ...
  return (
    <div className='aboutus mt-2'>
      ...
      <div className='text-center col-7 my-4'>
        <h3>Our Mission</h3>
        <p>"To help customer achieve their business objectives by providing innovative, best-in-class consulting, IT solution and services and to make it a joy for all stakeholders to work with us"</p>
      </div>
      <div className='text-center col-6 my-3'>
        <h3>Our Vision</h3>
        <p>"We believe in innovation of new technologies in line with changing business dynamics and change in business to bring affordable business solution, improved customer services and much more for end users."</p>
      </div>
      <div className='text-center col-6 my-3'>
        <h3>Specialaize In</h3>
        <p>"We are specialized in working on open cart projects and E-commerce sites, we work on new projects and as well as existing projects," We also do complete web development of your Web applications and wesites.</p>
      </div>
